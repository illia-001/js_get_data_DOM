...
document.querySelector('.total-population').textContent = converToThousands(totalPopulation);
document.querySelector('.average-population').textContent = converToThousands(averagePopulation);
